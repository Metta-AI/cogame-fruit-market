(function () {
  ...
  function showFailure(error) {
    ...
    // read on failure. `data-replay-loaded` is the success half, set below.
    document.documentElement.setAttribute('data-replay-error', error.message || String(error));
  ...
  function createCore(config) {
    ...
    function start() {
      ...
      try {
        worker = new Worker(workerUrl, { name: 'fruit-market-static-replay' });
