...
# Substitute: fruit-market, coworld-fruit-market, 8.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-fruit-market:ci)
#   SMOKE_SLUG                 game slug                        (fruit-market)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/fruit-market)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/fruit-market-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-fruit-market:ci}}"
slug="${SMOKE_SLUG:-fruit-market}"
